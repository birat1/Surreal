...
const FriendsFinderCard = ({
  ...
  return (
    <Card className="relative bg-blue-50 rounded-xl shadow-md hover:shadow-lg transition-shadow flex flex-col">
      ...
      <CardContent className="px-4 pb-4 pt-0 space-y-1 flex flex-col grow">
        <p>Age: {profile.age}</p>
